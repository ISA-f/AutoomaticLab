object E310GeneratorFrame: TE310GeneratorFrame
  ...
  object MasterClockLMDGroupBox: TLMDGroupBox
    ...
    TabOrder = 0
    object InternalMasterClockValueLMDLabel: TLMDLabel
      Left = 32
      Top = 83
      Width = 125
      Height = 27
    ...
    object MasterClockUnitLMDLabel: TLMDLabel
      Left = 159
      Top = 87
      Width = 34
      Height = 21
  ...
  object AnalogOutputsParsLMDGroupBox: TLMDGroupBox
    ...
    object AnalogOutputsGaindBLMDGroupBox: TLMDGroupBox
      ...
      object AnalogOutputsGaindBLabelLMDLabel: TLMDLabel
        Left = 109
        Top = 51
        Width = 31
        Height = 21
    ...
    object Output10OhmParsLMDGroupBox: TLMDGroupBox
      ...
      CaptionParentFont = False
      TabOrder = 2
      object Output10OhmAmplitudeLMDLabel: TLMDLabel
        Left = 18
        Top = 26
        Width = 160
        Height = 21
      ...
      object ApmlitudeOutput10OhmIndBLMDLabel: TLMDLabel
        Left = 187
        Top = 37
        Width = 97
        Height = 27
      ...
      object ApmlitudeOutput10OhmIndBLabelLMDLabel: TLMDLabel
        Left = 288
        Top = 40
        Width = 30
        Height = 21
      ...
      object ApmlitudeOutput10OhmInVLMDLabel: TLMDLabel
        Left = 187
        Top = 10
        Width = 97
        Height = 27
      ...
      object ApmlitudeOutput10OhmInVLabelLMDLabel: TLMDLabel
        Left = 288
        Top = 13
        Width = 20
        Height = 21
      ...
      object OffsetOutput10OhmLMDGroupBox: TLMDGroupBox
        ...
        object OffsetValueLMDGroupBox: TLMDGroupBox
          ...
          CaptionParentFont = False
          TabOrder = 1
          object OffsetValueOutput10OhmLabelLMDLabel: TLMDLabel
            Left = 177
            Top = 36
            Width = 18
            Height = 21
          ...
          object ActualOffsetValueOutput10OhmLMDLabel: TLMDLabel
            Left = 94
            Top = 47
            Width = 80
            Height = 27
          ...
          object ActualOffsetValueOutput10OhmLabelLMDLabel: TLMDLabel
            Left = 5
            Top = 50
            Width = 85
            Height = 21
    ...
    object Output50OhmParsLMDGroupBox: TLMDGroupBox
      ...
      CaptionParentFont = False
      TabOrder = 3
      object Output50OhmAmplitudeLMDLabel: TLMDLabel
        Left = 18
        Top = 25
        Width = 160
        Height = 21
      ...
      object ApmlitudeOutput50OhmIndBLMDLabel: TLMDLabel
        Left = 187
        Top = 37
        Width = 97
        Height = 27
      ...
      object ApmlitudeOutput50OhmInVLMDLabel: TLMDLabel
        Left = 187
        Top = 10
        Width = 97
        Height = 27
  ...
  object FrequencyParsLMDGroupBox: TLMDGroupBox
    ...
    CaptionParentFont = False
    TabOrder = 2
    object FinalFrequencyValueLMDLabel: TLMDLabel
      Left = 178
      Top = 219
      Width = 125
      Height = 27
    ...
    object FinalFrequencyUnitLMDLabel: TLMDLabel
      Left = 306
      Top = 222
      Width = 34
      Height = 21
    ...
    object FinalFrequencyLabelLMDLabel: TLMDLabel
      Left = 7
      Top = 226
      Width = 169
      Height = 21
    ...
    object NumberOfIncrementsLabelLMDLabel: TLMDLabel
      Left = 7
      Top = 197
      Width = 169
      Height = 21
    ...
    object IncrementIntervalParsLMDGroupBox: TLMDGroupBox
      ...
      object DurationLMDLabel: TLMDLabel
        Left = 191
        Top = 157
        Width = 135
        Height = 27
      ...
      object DurationUnitLMDLabel: TLMDLabel
        Left = 328
        Top = 160
        Width = 29
        Height = 21
    ...
    object StartFrequencyLMDGroupBox: TLMDGroupBox
      ...
      CaptionParentFont = False
      TabOrder = 0
      object StartFrequencyUnitLMDLabel: TLMDLabel
        Left = 275
        Top = 40
        Width = 34
        Height = 21
      ...
      object ActualStartFrequencyValueLMDLabel: TLMDLabel
        Left = 145
        Top = 52
        Width = 125
        Height = 27
      ...
      object DesiredStartFrequencyLabelLMDLabel: TLMDLabel
        Left = 53
        Top = 27
        Width = 88
        Height = 21
      ...
      object ActualStartFrequencyLMDLabel: TLMDLabel
        Left = 53
        Top = 55
        Width = 88
        Height = 21
    ...
    object FrequencyIncrementLMDGroupBox: TLMDGroupBox
      ...
      CaptionParentFont = False
      TabOrder = 1
      object DesiredFrequencyIncrementLabelLMDLabel: TLMDLabel
        Left = 53
        Top = 28
        Width = 88
        Height = 21
      ...
      object FrequencyIncrementsUnitLMDLabel: TLMDLabel
        Left = 275
        Top = 40
        Width = 34
        Height = 21
      ...
      object ActualFrequencyIncrementLabeLMDLabel: TLMDLabel
        Left = 53
        Top = 55
        Width = 88
        Height = 21
      ...
      object ActualFrequencyIncrementLMDLabel: TLMDLabel
        Left = 145
        Top = 52
        Width = 125
        Height = 27
