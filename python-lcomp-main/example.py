...
if __name__ == "__main__":
  #  with LCOMP(slot=0) as ldev:     # либо ldev.OpenLDevice() в начале и ldev.CloseLDevice() в конце
        ...
        if slPar.BoardType in (E140, E440, E154):
            ...
            adcPar.t3.dKadr = 0.025                              # 0.0025                    0.01
            adcPar.t3.SynchroType = e440.NO_SYNC                # e440.NO_SYNC              e154.NO_SYNC
            adcPar.t3.SynchroSensitivity = e440.A_SYNC_LEVEL    # e440.A_SYNC_LEVEL         e154.A_SYNC_LEVEL
            adcPar.t3.SynchroMode = e440.A_SYNC_UP_EDGE         # e440.A_SYNC_UP_EDGE       e154.A_SYNC_UP_EDGE
            adcPar.t3.AdChannel = 0
            adcPar.t3.AdPorog = 0
            adcPar.t3.NCh = 1                                   # 1 - 16                    1 - 8
            adcPar.t3.Chn[0] = e440.CH_0 | e440.V10000 | e440.CH_DIFF     # для дифференциального режима
        ...
        if slPar.BoardType == E140:
            ...
            print("Time GetDataADC: ", end - start)
        elif slPar.BoardType == E154:
