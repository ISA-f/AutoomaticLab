...
__fastcall TMainForm::TMainForm(TComponent* Owner) : TForm(Owner)
{
	...
	{
		// для windows 7 и выше проведем легкий тюнинг элементов LMD
...
{
	// пробуем запустить поток обнаружения модуля
	IsInitDevicesThreadRunning = false;
...
//		if(LMDGroupBox) LMDGroupBox->CaptionFont3D->Tracing = 0x0;
		...
		// рихтуем заглавие группы радиокнопок
...
/*		TLMDButton *LMDButton;
		...
		// рихтуем название кнопки выбора
