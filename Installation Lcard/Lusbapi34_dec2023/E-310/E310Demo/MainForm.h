...
class TMainForm : public TForm
{
	...
	TShape *ModuleDetectionShape;
	TLMDLabel *ModuleDetectionLMDLabel;
	TLMDLabel *VirtualSlotLabelLMDLabel;
	TLMDLabel *VirtualSlotLMDLabel;
...
//		TE310GeneratorFrame *GeneratorFrame;
	...
	public:		// User declarations
		...
		void LmdControlElementsTuning(TWinControl *WinControlElement);
