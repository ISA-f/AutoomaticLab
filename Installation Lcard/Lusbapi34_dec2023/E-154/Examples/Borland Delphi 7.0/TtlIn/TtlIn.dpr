//******************************************************************************
// Модуль E-154.
// Консольная программа с циклической организацией однократного
// ввода данных с входных цифровых линий
//******************************************************************************
program TtlInLines;
...
begin
	...
	if not Boolean(AnsiCompareStr(ModuleName, pAnsiChar('E154'))) then AbortProgram('Обнаруженный модуль не является E-154!')
	...
	// Цикл перманетной работы функции TTL_IN().
	...
	while true do
	   begin
			...
			// отобразим на экране полученные состояния
