...
class LcardE2010B_Autoread(Abstract_Device.Device):
    myData = properties.MyProperty(0)
    ...
    def TakeMeasurements(self):
        ...
        """
        print("Starting measurements Lcard")
    ...
    def ReadFlashDataAveraged(self):
        x = e2010.GetDataADC(self.adcPar.t4, self.plDescr, # считываем буффер с Lcard
                                    self.data_ptr, self.buffer_size) 
        return x
...
if __name__ == "__main__":
        ...
        #time.sleep(10)
        #myLcard.ReadFlashDataAveraged()
        
        myLcard.StartMeasurements("measurementE2010B.txt")
        print(time.time())
        for i in range(10000):
            x = myLcard.ReadFlashDataAveraged()
        print(time.time())
